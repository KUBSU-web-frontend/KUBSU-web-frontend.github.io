...
<div class="b-container mx-auto" id="navigationbar">
  <div id="wrapnavbar">
    <div id="b-logo">
      <a class="logotip" href="/"><img id="lgtp" src="img/drupal-coder.svg" alt="Главная" width="175" > </a>
    </div>
    <div id="navbar">
        ...
        <li class="nav-item items">
          ...
          <div class="dropwrapper">
            <ul class="dropdown-menu1">
              ...
              <li><a class="nav-link items brdrs" href="#">Бэкапы</a></li>
              <li><a class="nav-link items brdrs" href="#">Миграция</a></li>
  ...
  <div class="team">
    ...
    <div class="team__list">
        <div class="team__list-item">
            ...
            <div class="team__descr">
                ...
                <div class="team__descr-position">Руководитель отдела веб-разработки, канд. техн. наук, заместитель директора</div>
            </div>
        </div>
        <div class="team__list-item">
          <div class="team__photo">
    ...
    <div class="team__list-item">
        ...
        <div class="team__descr">
            ...
            <div class="team__descr-position">Руководитель отдела продвижения, контекстной рекламы и контент-поддержки сайтов</div>
        </div>
    </div>
    <div class="team__list-item">
        <div class="team__photo">
  ...
  <div class="reviews">
    ...
    <div class="rect-wrapper">
      ...
      <div class="slick__arrows">
        <span class="slick-slide-num" ><span class="slick-slide-num-current"></span>/ 7</span>
      </div>
    </div>
  </div>
</div>
...
<div class="social-links">
  <ul class="social-links-wrapper">
    <li class="social-links-item"><a title="YouTube" target="_blank" href="https://www.youtube.com/channel/UCyFEbngMB-bK2ulNtd_W43A"><i class="fab fa-facebook-f"></i></a></li>
    ...
    <li class="social-links-item"><a title="YouTube" target="_blank" href="https://www.youtube.com/channel/UCyFEbngMB-bK2ulNtd_W43A"><i class="fab fa-youtube"></i></a></li>
